...
const AddCar = () => {
  ...
  const { axios, currency, isAdmin, user } = useAppContext()
  ...
  const getTitle = () => {
    if (isAdmin) return 'Add New Car to Platform';
    return 'List Your Car for Rent';
  }
  ...
  return (
    <div className='min-h-full bg-gradient-to-b from-sky-400 via-blue-300 to-yellow-200 overflow-auto relative'>
      ...
      {/* Mountains at bottom - absolute position */}
      <div className="absolute bottom-0 left-0 right-0 pointer-events-none">
        ...
        {/* Green grass/trees at very bottom */}
        ...
        <div className="w-full max-w-6xl my-8">
          ...
          <div className='mb-3'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div>
                <p className='text-xs text-gray-700 font-medium'>Upload a clear picture of your car</p>
          ...
          <div className='mb-3'>
            ...
            <input 
              type="text" 
              placeholder='Enter city or area (e.g. Mumbai, Delhi, Gandhinagar...)' 
              required 
              className='w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md outline-none focus:border-primary focus:ring-1 focus:ring-primary' 
              value={car.location} 
              onChange={e => setCar({ ...car, location: e.target.value })} 
            />
            <p className="text-xs text-gray-500 mt-0.5">Enter the city or area where the car is available</p>
          </div>
          ...
          <div className='mb-3'>
            ...
            <textarea 
              rows={2} 
              placeholder='Describe your car features, condition, and any special notes for renters...' 
              required 
              className='w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none' 
              value={car.description} 
              onChange={e => setCar({ ...car, description: e.target.value })}
              minLength="10"
            ></textarea>
            <p className="text-xs text-gray-500 mt-0.5">Minimum 10 characters ({car.description.length}/10)</p>
          </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className='flex items-center gap-2 px-4 py-2 text-sm bg-primary hover:bg-primary-dull text-white rounded-md font-medium cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
            >
              {isLoading ? (
                <>
                ...
                <>
                  ...
                  {isAdmin ? 'Add to Platform' : 'Submit for Approval'}
                </>
              )}
            </button>
          </div>
