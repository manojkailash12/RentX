...
const EmployeeAddAdminCar = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    setIsLoading(true);
    const loadingToast = toast.loading('Adding admin car...');

    try {
      const formData = new FormData();
      formData.append('image', image);
      formData.append('addForAdmin', 'true'); // Flag to indicate this is an admin car
    ...
    <div className='min-h-screen bg-gradient-to-b from-sky-400 via-blue-300 to-yellow-200 overflow-y-auto relative'>
      ...
      <div className="relative z-10 min-h-screen flex items-start justify-center p-3 md:p-4 pb-72 pt-8">
        <div className="w-full max-w-6xl my-8">
          ...
          <div className="mb-2">
            <Title title="Add Admin Car" subTitle="Add cars to the platform inventory. These cars are auto-approved and owned by admin." />
          </div>

          <div className="mb-3">
            <span className="px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700">
              Employee - Adding for Admin (Auto Approved)
            </span>
          </div>
...
export default EmployeeAddAdminCar
