...
const EmployeeAddCar = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    setIsLoading(true);
    const loadingToast = toast.loading('Submitting car for approval...');
    ...
    <div className='min-h-screen bg-gradient-to-b from-sky-400 via-blue-300 to-yellow-200 overflow-y-auto relative'>
      ...
      <div className="relative z-10 min-h-screen flex items-start justify-center p-3 md:p-4 pb-72 pt-8">
        <div className="w-full max-w-6xl my-8">
          ...
          <div className="mb-2">
            <Title title="Add My Rental Car" subTitle="Add your own car for rent. Your car will need admin approval before being available for booking." />
          </div>

          <div className="mb-3">
            <span className="px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-700">
              Employee - Personal Car (Requires Admin Approval)
            </span>
          </div>
          ...
          <div className='mb-3'>
            ...
            <textarea rows={2} placeholder='Describe your car features, condition, and any special notes for renters...' required className='w-full px-3 py-1.5 text-sm border border-gray-300 rounded-md outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none' value={car.description} onChange={e => setCar({ ...car, description: e.target.value })} minLength="10"></textarea>
          </div>
