  ...
  return (
    <motion.div
      ...
      <div className='text-white'>
        <h2 className='text-3xl font-medium'>List Your Car</h2>
        <p className='mt-2'>Earn money by renting your vehicle.</p>
        <motion.button
      ...
      <motion.img
        ...
        src={assets.banner_car_image} alt="car" className='max-h-45 mt=16' />
    </motion.div>
  )
}
